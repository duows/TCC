...
Essa ausência de poda não constitui ineficiência do motor de inferência, mas decorre
diretamente da definição de consistência de arco apresentada na
Seção~\ref{sec:ac3}. Com domínios completos, cada valor de uma variável encontra
suporte em ao menos um valor de cada variável vizinha, de modo que nenhum valor se torna
elegível à remoção. O motor executa, verifica que a rede já se encontra arco-consistente e
encerra sem podar. A economia observada neste regime é, portanto, de natureza algorítmica e
não de redução de domínio, o AC-3 decide a consistência da rede sem enumerar o espaço de
configurações completas, enquanto a força bruta o percorre em sua totalidade. A
