...
\begin{quadro}[htb]
  ...
  \begin{tabular}{|p{3.2cm}|p{11.8cm}|}
    ...
    \begin{enumerate}[nosep,leftmargin=1.2em,topsep=2pt,partopsep=0pt,parsep=0pt,itemsep=1pt]
      ...
      \item A restrição é transitiva nas plataformas AM4 e AM5 modeladas: depende da placa-mãe, que por sua vez depende da CPU selecionada.
...
\begin{quadro}[htb]
  ...
  \begin{tabular}{|p{3.2cm}|p{11.8cm}|}
    ...
    \textbf{Atributos:} TDP da CPU (W), TDP da GPU (W), potência da fonte (W), margem de segurança cadastrada (25\%).
    \textbf{Exemplos:} \{GPU TDP: 220\,W, Fonte: 250\,W\} $\rightarrow$ incompatível, pois 220\,W $\times$ 1,25 = 275\,W e a fonte oferece 250\,W; \{GPU TDP: 220\,W, Fonte: 550\,W\} $\rightarrow$ compatível, pois 550\,W $\geq$ 275\,W.
    \textbf{Restrições:}
    \begin{enumerate}[nosep,leftmargin=1.2em,topsep=2pt,partopsep=0pt,parsep=0pt,itemsep=1pt]
      \item A fonte deve suprir a demanda energética de cada componente de maior consumo (CPU e GPU) individualmente, acrescida de margem de segurança de 25\%, preservando a natureza binária das restrições do grafo.
...
\begin{quadro}[htb]
  ...
  \begin{tabular}{|p{3.2cm}|p{11.8cm}|}
    ...
    \textbf{Exemplos:} ``Esta fonte de 350\,W é insuficiente para a Radeon RX 7900 XT, cujo consumo de 315\,W exige no mínimo 393,75\,W com a margem de segurança de 25\% aplicada.''
    \textbf{Restrições:}
    \begin{enumerate}[nosep,leftmargin=1.2em,topsep=2pt,partopsep=0pt,parsep=0pt,itemsep=1pt]
