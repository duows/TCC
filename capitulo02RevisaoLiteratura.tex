...
expresso em watts. A fonte de alimentação deve fornecer capacidade suficiente para atender à demanda energética dos componentes, com uma margem de segurança
recomendada de aproximadamente 20\% a 30\% acima do consumo \cite{ATXSPEC2022}. Embora o dimensionamento físico de uma fonte considere o
...
O grafo de restrições apresentado na Subseção 2.3.3 possui cinco vértices e
...
dependências entre os componentes considerados.

A literatura estabelece que CSPs cujo grafo de restrições é uma árvore
constituem uma subclasse tratável, resolvível em tempo $O(nd^2)$ por meio de
arco-consistência direcionada sobre uma ordenação topológica das variáveis,
sem necessidade de busca com retrocesso (Russell; Norvig, 2010). Em redes
acíclicas, a arco-consistência é suficiente para decidir a consistência
global: uma vez estabelecida, qualquer atribuição pode ser estendida a uma
solução completa sem retrocesso.
...
discutida entre os trabalhos futuros no Capítulo 11.
...
completa e eficiente de propagação, que garante consistência global na rede, é o Algoritmo AC-3 \cite{Mackworth1977,Russell2010}.
...
um SE educacional articula a cadeia de raciocínio que levou aquela conclusão em linguagem acessível ao usuário \cite{Clancey1983}.
